...
_L9:
        ...
        View getViewForPosition(int i, boolean flag)
        {
            ...
            if (k != 0 && !mState.isPreLayout() && viewholder.hasAnyOfTheFlags(8192))
            {
                ...
                {
                    j = ItemAnimator.buildAdapterChangeFlagsForAnimations(viewholder);
...
_L4:
        ...
        int j2 = (int)(MotionEventCompat.getX(motionevent, i) + 0.5F);
        int k2 = (int)(MotionEventCompat.getY(motionevent, i) + 0.5F);
        int k1 = mLastTouchX - j2;
        int i1 = mLastTouchY - k2;
        int k = k1;
        i = i1;
        if (dispatchNestedPreScroll(k1, i1, mScrollConsumed, mScrollOffset))
        {
            k = k1 - mScrollConsumed[0];
        ...
        if (mScrollState == 1)
        {
            ...
            i = ((flag) ? 1 : 0);
            if (scrollByInternal(l1, k1, motionevent1))
            {
                getParent().requestDisallowInterceptTouchEvent(true);
                i = ((flag) ? 1 : 0);
            }
